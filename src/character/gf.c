...
static const CharFrame char_gf_frame[] = {
	{GF_ArcMain_BopLeft, {  0,   0,  195, 94}, { 41,  73}}, //0 bop left 1
	{GF_ArcMain_BopLeft, {  0,  95,  181, 95}, { 40,  73}}, //1 bop left 2


	{GF_ArcMain_BopRight, {  0,   0,  175, 94}, { 40,  73}}, //2 bop right 1
	{GF_ArcMain_BopRight, {  0,  95,  194, 94}, { 40,  72}}, //3 bop right 2
	
	{GF_ArcMain_Cry, {  0,   0, 181, 95}, { 40,  73}}, //4 cry
	{GF_ArcMain_Cry, {  0,  96, 174, 94}, { 40,  72}}, //5 cry
};

static const Animation char_gf_anim[CharAnim_Max] = {
	{0, (const u8[]){ASCR_CHGANI, CharAnim_Left}},                           //CharAnim_Idle
	{1, (const u8[]){ 1,  1,  1,  2,  2,  2,  3,  3,  3,  4,  4,  ASCR_BACK, 1}}, //CharAnim_Left
	...
	{1, (const u8[]){ 1,  1,  1,  5,  5,  5,  0,  0,  0,  0,  1,  1, ASCR_BACK, 1}}, //CharAnim_Right
