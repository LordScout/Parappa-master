...
//Menu messages
static const char *funny_messages[][4] = {
	{"PSX PORT BY CUCKYDEV", "SETTING STANDARDS", "YOU KNOW IT", "SUCK IT DOWN"},
	{"YOU GOTTA DO WHAT", "I GOTTA RECEIVE", "BUT MOST IMPORTANT", "I GOTTA BELIEVE"},
	{"LIKE PARAPPA", "BUT COOLER", "OH WAIT", "IT IS PARAPPA"},
	{"lool", "inverted colours", "wacky effect", "arent they cool"},
	{"DOPE ASS GAME", "PLAYSTATION MAGAZINE", "REVOLUTIONARY RHYTHM GAME", "BUT WHICH ONE IS IT"},
	{"ITS MORE MALICIOUS", "THAN ANYTHING", "OK OKAY", "WATCH THIS"},
	{"USE A CONTROLLER", "LOL", "PLAYSTATION ARROW SKIN", "YOU DECIDE"},
	{"SHOUT OUT TO SMOKEY", "HES THE HOMIE", "SYLVERSTAR TOO", "HE MADE ALL THE ASSETS"},
	{"YOU KNOW WHAT", "FUCK IT", "WERE GOING FULL CIRCLE", "GET READY"},
	{"PLAYING ON EPSXE HUH", "YOURE THE PROBLEM", "GET A REAL EMULATOR", "PUNK ASS BITCH"},
	{"GET ME TO STOP", "TRY", "OPEN SOURCE", "FOREVER"},
};
...
void Menu_Load(MenuPage page)
{
	...
	menu.gf = Char_GF_New(FIXED_DEC(6,1), FIXED_DEC(60,1));
...
void Menu_Tick(void)
{
	...
	//Get song position
	u16 next_step = Audio_TellXA_Milli() / 133; //100 BPM
		...
		case MenuPage_Opening:
		{
			...
			else
			{
				...
				//Fallthrough
					...
					case 9:
					case 8:
						menu.font_bold.draw(&menu.font_bold, "SYLVERSTAR", SCREEN_WIDTH2, SCREEN_HEIGHT2, FontAlign_Center);
				//Fallthrough
					case 7:
					case 6:
					case 5:
					case 4:
						menu.font_bold.draw(&menu.font_bold, "ORIGINALLY BY", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 16, FontAlign_Center);
				//Fallthrough
					case 3:
					case 2:
					case 1:
					case 0:
						menu.font_bold.draw(&menu.font_bold, "PARAPPA MOD",   SCREEN_WIDTH2, SCREEN_HEIGHT2 - 32, FontAlign_Center);
						break;
					case 23:
					case 22:
					case 21:
				...
				//Fallthrough
					...
					case 17:
					case 16:
						menu.font_bold.draw(&menu.font_bold, "PSX PORT", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 64, FontAlign_Center);
						menu.font_bold.draw(&menu.font_bold, "CREATED BY",           SCREEN_WIDTH2, SCREEN_HEIGHT2 - 48, FontAlign_Center);
					case 15:
					case 14:
						break;
				...
				//Fallthrough
					case 31:
					case 30:
						menu.font_bold.draw(&menu.font_bold, funny_message[3], SCREEN_WIDTH2, SCREEN_HEIGHT2 + 32, FontAlign_Center);
				//Fallthrough
					case 29:
					case 28:
				...
				//Fallout
					...
					case 38:
					case 37:
						menu.font_bold.draw(&menu.font_bold, "FULL CIRCLE", SCREEN_WIDTH2, SCREEN_HEIGHT2, FontAlign_Center);
				//Fallthrough
					case 36:
					case 35:
					case 34:
					case 33:
					case 32:
						menu.font_bold.draw(&menu.font_bold, "FUCK IT", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 16, FontAlign_Center);
						break;
				...
				//Fallout
					...
					case 45:
					case 44:
						menu.font_bold.draw(&menu.font_bold, "WITH PARAPPA", SCREEN_WIDTH2, SCREEN_HEIGHT2 + 24, FontAlign_Center);
				//Fallthrough
					case 43:
					case 42: 
	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{"4", StageId_4_1, "PARAPPA WEEK", {"KICK PUNCH", "DRIVERS TEST", "FLEA MARKET"}},
		...
		case MenuPage_Freeplay:
		{
			static const struct
			{
				...
				{StageId_4_1, "MASTER ONIONS RAP"},
				{StageId_4_2, "MOOSELINIS RAP"},
				{StageId_4_3, "FLEESWALLOWS RAP"},
				{StageId_1_1, "BOPEEBO"},
				{StageId_1_2, "FRESH"},
		...
		case MenuPage_Mods:
		{
			static const struct
			{
				...
				{StageId_Kapi_2, "  PARAPPA FNF PSX PORT", false},
				{StageId_Clwn_1, "CUCKYDEV", false},
				{StageId_Clwn_2, "   PSXFUNKIN", false},
				{StageId_Clwn_1, "SYLVERSTAR", false},
				{StageId_Kapi_2, "	CREATOR OF PARAPPA MOD", false},
				{StageId_Kapi_2, "	ARTIST", false},
				{StageId_Clwn_1, "SMOKEY", false},
				{StageId_Clwn_1, "	CODER OF OG MOD", false},
				{StageId_Clwn_1, "	BRO", false},
				{StageId_Clwn_1, "MIAPAISANO", false},
				{StageId_Clwn_1, "   ICON ARTIST", false},
				{StageId_Clwn_1, "SPECIAL THANKS", false},
				{StageId_Kapi_1, "   RODNEY GREENBLAT", false},
				{StageId_Kapi_1, "   MASAYA MATSUURA", false},
